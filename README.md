...
### Cloud Providers (CloudProvider interface)
...
### Pipeline Providers (PipelineProvider interface)
...
### SRE Providers (SREProvider interface)
| Provider | Features | Status |
|----------|----------|--------|
...
providers:
  - name: aws-prod
    ...
    config:
      region: us-east-1
      access_key_id_env: AWS_ACCESS_KEY_ID     # Resolved from env
